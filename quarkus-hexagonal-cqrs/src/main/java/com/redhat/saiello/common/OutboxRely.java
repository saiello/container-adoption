...
//        return OutboxItem.<OutboxItem>stream("publishedAt is null").onItem()
...
//                    return OutboxItem.update("publishedAt = ?1 where id IN(?2)", Instant.now(), events);
//                }).replaceWithVoid();
//    }
//
